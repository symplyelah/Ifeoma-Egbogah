...
```{r echo=FALSE, fig.align='center', fig.cap="Ireland's Olympic Story by Irish Times"}

knitr::include_graphics("content/blog/Bad Chart/irish.jpg")
...
```{r Ireland, echo=FALSE}

library(tidyverse)

olympic <- read_csv("content/blog/Bad Chart/summer_olympic_medals.csv") %>% 
  janitor::clean_names() 
...
ireland %>% 
  ...
  geom_text(aes(label = paste0(medal_rank, rep("th", 6))), nudge_y = 4) +
...
{{< /panel >}}
{{< panel name = "Code" >}}
```{r ref.label='Ireland', fig.show='hide'}
...
Source data [here](https://www.kaggle.com/datasets/ramontanoeiro/summer-olympic-medals-1986-2020/data)
