...
Let's see how well the shape parameters for the beta distribution fit the distribution of the raw winning averages shown in the histogram. We can plot the distribution and observe the fit. 
