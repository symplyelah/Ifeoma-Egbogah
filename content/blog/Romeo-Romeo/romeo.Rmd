...
romeo_juliet <- read_csv("romeo_juliet.csv")
...
```{r echo=FALSE, fig.align='center', fig.width = 25, fig.height = 23.63, fig.cap='AI Generated Art'}

image_read("romeo.png")
...
romeo_juliet_token <- romeo_juliet %>% 
  drop_na() %>% 
  unnest_tokens(word, dialogue)%>% 
  mutate(word = ifelse(word == "swords", "sword", word)) %>% 
...
```{r top_word, message = FALSE, warning=FALSE, fig.width = 25, fig.height = 23.63, echo=FALSE, include=FALSE}
...
```{r character, warning=FALSE, fig.width = 25, fig.height = 23.63, echo=FALSE, include=FALSE}
...
```{r romeo_juliet, warning=FALSE, fig.width = 25, fig.height = 23.63, echo=FALSE, include=FALSE}
...
```{r Median_Position, warning=FALSE, fig.width = 25, fig.height = 23.63, include=FALSE}
...
```{r trend, warning=FALSE, fig.width = 25, fig.height = 23.63, include=FALSE}
...
```{r peak, warning=FALSE, fig.width = 25, fig.height = 23.63, include=FALSE}
...
```{r sentiment, warning=FALSE, fig.width = 25, fig.height = 23.63, include=FALSE}
