...
```{r echo=FALSE, fig.align='center', fig.cap="Ireland's Olympic Story by Irish Times", fig.width = 25, fig.height = 23.63}

image_read("ireland.png")
...
```{r Ireland, warning=FALSE, fig.width = 25, fig.height = 23.63, include=FALSE}
