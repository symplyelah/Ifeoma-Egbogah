...
As we can see the raw winning average isn't a good estimate for determining who the best and worst managers are in the league. Let's get a better estimate using the empirical Bayes. The first step in Bayesian analysis is to choose a prior distribution. Since we are using empirical Bayes we will be taking our prior distribution from the data. Not very Bayesian. I know, I know. Since I have a reasonable amount of data I decided to use empirical Bayes. Since our data is binomial we will be fitting the beta distribution to our data to get our prior. This is what our model looks like: 
